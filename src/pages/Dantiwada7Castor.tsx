...
import dantiwada7Image from "@/assets/dantiwada7-castor.jpeg";
import { Card } from "@/components/ui/card";
import { Separator } from "@/components/ui/separator";

const Dantiwada7Castor = () => {
  return (
      ...
      <section className="bg-background py-6 md:py-8 border-b border-border/30">
        <div className="container max-w-4xl mx-auto px-4">
          <h2 className="text-2xl md:text-4xl font-bold text-foreground leading-tight">
            Dantiwada-7 - Research Castor Seeds
          </h2>
      ...
      <section className="bg-background py-8 md:py-10">
        <div className="container max-w-4xl mx-auto px-4">
          <div className="flex justify-center">
            <img
              src={dantiwada7Image}
              alt="Dantiwada-7 Research Castor Seeds Package"
...
export default Dantiwada7Castor;
