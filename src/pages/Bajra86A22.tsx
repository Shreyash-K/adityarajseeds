...
import bajra86a22Image from "@/assets/86a22-bajra.jpeg";
        ...
        <div className="container max-w-4xl mx-auto px-4">
          <div className="flex justify-center">
            <div className="text-center">
              <img
                src={bajra86a22Image}
                alt="86A22 Hybrid Bajra Seeds Package"
                className="w-full max-w-2xl rounded-lg shadow-lg"
              />
              <h3 className="text-xl font-bold text-primary mt-4">86A22</h3>
            </div>
          </div>
        </div>
      </section>
