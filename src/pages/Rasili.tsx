...
import rasiliSeedsImage from "@/assets/rasili-seeds.jpeg";
      ...
      <section className="bg-background py-8 md:py-10">
        <div className="container max-w-4xl mx-auto px-4">
          <div className="flex justify-center">
            <img
              src={rasiliSeedsImage}
              alt="Rasili Hybrid Sorghum Sudan Grass Seeds Package"
