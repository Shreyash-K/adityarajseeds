...
import asian21Image from "@/assets/asian-21-mustard.jpeg.asset.json";
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-green-700 mb-6">
            ASIAN-21 - Research Mustard Seeds - રાઈ / राई / मोहरी
          </h2>
          <div className="flex justify-center max-w-4xl mx-auto">
            <div>
              <img
                src={asian21Image.url}
                alt="Asian-21 Research Mustard Seeds Package"
                className="w-full h-auto rounded-lg shadow-lg"
              />
              <p className="mt-3 text-lg font-semibold text-green-700">ASIAN-21 - Research Mustard Seeds</p>
            </div>
          </div>
        </div>
