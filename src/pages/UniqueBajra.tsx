      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <img
              src={uniqueBajraImage}
              alt="Unique Multicut Fodder Hybrid Bajra"
              className="w-full max-w-md mx-auto rounded-lg shadow-lg mb-6"
            />
            <h2 className="text-2xl md:text-3xl font-bold text-primary mb-2">
              UNIQUE - Multicut Fodder Hybrid Bajra
            </h2>
            <p className="text-lg text-muted-foreground">રજકા બાજરી - रजका बाजरा</p>
          </div>
