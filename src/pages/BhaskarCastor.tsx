...
import bhaskarImage from "@/assets/bhaskar-castor.jpeg";
import panamaImage from "@/assets/panama-castor.jpeg";
      ...
      <section className="bg-background py-6 md:py-8 border-b border-border/30">
        <div className="container max-w-4xl mx-auto px-4">
          <h2 className="text-2xl md:text-4xl font-bold text-foreground leading-tight">
            Bhaskar & Panama - Research Castor Seeds
          </h2>
          <p className="text-lg text-muted-foreground mt-2 font-devanagari">
            સંશોધિત દિવેલા | संशोधित अरंडी
          </p>
        </div>
      </section>
        ...
        <div className="container max-w-4xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex flex-col items-center">
              <img
                src={bhaskarImage}
                alt="Bhaskar - Research Castor Seeds Package"
                className="w-full max-w-sm rounded-lg shadow-lg"
              />
              <p className="mt-3 text-lg font-bold text-foreground">Bhaskar (ભાસ્કર)</p>
            </div>
            <div className="flex flex-col items-center">
              <img
                src={panamaImage}
                alt="Panama - Research Castor Seeds Package"
                className="w-full max-w-sm rounded-lg shadow-lg"
              />
              <p className="mt-3 text-lg font-bold text-foreground">Panama (પનામા)</p>
            </div>
          </div>
        </div>
      </section>
