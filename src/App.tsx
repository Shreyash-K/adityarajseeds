...
import WhiteGold from "./pages/WhiteGold";
import SundaramG2 from "./pages/SundaramG2";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/white-gold" element={<WhiteGold />} />
          <Route path="/sundaram-g2" element={<SundaramG2 />} />
